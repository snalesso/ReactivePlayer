...
namespace ReactivePlayer.Core.Application.Services.Playback.CSCore
{
    ...
    public class CSCorePlaybackService : IPlaybackService // TODO: learn how to handle IDisposable from outside and in general how to handle interfaces which implementations may or may not be IDisposable
    {
        ...
        public CSCorePlaybackService(TimeSpan positionUpdateInterval)
        {
        ...
        public CSCorePlaybackService() : this(CSCorePlaybackService.DefaultPositionUpdateInterval) { }
