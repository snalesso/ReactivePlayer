...
namespace ReactivePlayer.Banana
{
    public class TrackViewModel : ReactiveScreen, IDisposable
    {
            ...
            )
        {
            ...
            this._isLoved_OAPH = this.Track.ObservableForProperty(x => x.IsLoved, skipInitial: false).Select(x => x.Value)
            ...
            //    () =>
            //    {
            //        this._dialogService.ShowDialogAsync(this._editTrackTagsViewModelFactoryMethod?.Invoke(this.Track));
            //    });
