using ReactivePlayer.Application.WPF.ReactiveCaliburnMicro;
...
{
    public class PlaybackViewModel : ReactiveScreen // ReactiveObject
    {
            ...
            IReadLibraryService readLibraryService)
        {
            ...
            this.PlaySelected = ReactiveCommand.CreateFromTask(
                async (Uri trackLocation) =>
                {
        ...
        public ReactiveCommand<Uri, Unit> PlaySelected { get; }
