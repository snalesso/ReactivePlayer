...
namespace ReactivePlayer.UI.Wpf.Behaviors
{
    ...
    /// </summary>
    public class TreeViewTracksSubsetViewModelBehavior : Behavior<TreeView>
    {
        /// <summary>
        ...
        public static readonly DependencyProperty SelectedItemProperty =
            DependencyProperty.Register(
                nameof(SelectedItem),
                typeof(object),
                typeof(TreeViewTracksSubsetViewModelBehavior),
        ...
        private static void OnSelectedItemChanged(DependencyObject sender, DependencyPropertyChangedEventArgs e)
        {
            ...
            var behavior = (TreeViewTracksSubsetViewModelBehavior)sender;
            ...
            if (!(e.NewValue is TracksSubsetViewModel dataContext))
            {
                return;
            }

            var dataContextReversedRoute = new List<TracksSubsetViewModel>();
