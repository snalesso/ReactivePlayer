...
{
    public sealed class NewtonsoftBsonArtistsRepository : IArtistsRepository // TODO: IDisposable to close FileStream????
    {
        ...
        public NewtonsoftBsonArtistsRepository(Uri dbFileLocation)
        {
