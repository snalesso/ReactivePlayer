...
using ReactivePlayer.Core.Playback.CSCore.Codecs;
using ReactiveUI;
using System;
...
namespace ReactivePlayer.Core.Playback.CSCore
{
    ...
    public class CSCoreAudioPlaybackEngineAsync : IAudioPlaybackEngineAsync // TODO: learn how to handle IDisposable from outside and in general how to handle interfaces which implementations may or may not be IDisposable
    {
        #region constants & fields

        // TODO: benchmark what impact would have to set position updates to a higher frequency
