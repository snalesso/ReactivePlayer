...
namespace ReactivePlayer.Domain.Repositories
{
    public sealed class ITunesXMLRepository : ITracksRepository
    {
        ...
        {
            return Task.FromResult(this._tracks);
        }
        ...
        private IReadOnlyList<Track> GetITunesXMLMediaLibraryTracks()
        {
            ...
            try
            {
                ...
                foreach (var t in itTracks)
                {
                    try
                    {
                        ...
                        {
                                tt => tt.Tags.Performers.EmptyIfNull().Contains(null),
                                tt => tt.Tags.Composers.EmptyIfNull().Contains(null)
                        };
