...
{    
    ...
    public class Equalizer : Control
    {
        ...
        {
            if (value == null || value.Length != this.NumberOfBands)
                return new float[this.NumberOfBands];
            return value;
        }
        ...
        {
            if (newValue == null || newValue.Length != this.NumberOfBands)
                this.SetEqualizerValues(new float[this.NumberOfBands]);
            else
                this.SetEqualizerValues(newValue);
        }
        ...
        public float[] EqualizerValues
        {
            ...
            get
            {
                return (float[])this.GetValue(EqualizerValuesProperty);
            }
            set
            {
                this.SetValue(EqualizerValuesProperty, value);
            }
        }
        #endregion
        ...
        public int NumberOfBands
        {
            ...
            get
            {
                return (int)this.GetValue(NumberOfBandsProperty);
            }
            set
            {
                this.SetValue(NumberOfBandsProperty, value);
            }
        }
        ...
        public override void OnApplyTemplate()
        {
            ...
            if (this.equalizerGrid != null)
                this.equalizerGrid.Children.Clear();

            this.equalizerGrid = this.GetTemplateChild("PART_EqualizerGrid") as Grid;
        ...
        private void CreateSliders()
        {
            ...
            this.ClearSliders();
            this.equalizerGrid.ColumnDefinitions.Clear();
            for (int i = 0; i < this.NumberOfBands; i++)
            {
                ...
                this.equalizerGrid.ColumnDefinitions.Add(channelColumn);
                Slider slider = new Slider()
                {
                    Style = (Style)this.FindResource("EqualizerSlider"),
                    Maximum = 1.0,
                    Minimum = -1.0,
                    SmallChange = 0.01,
                    LargeChange = 0.1,
                ...
                this.equalizerGrid.Children.Add(slider);
        ...
        {
            this.EqualizerValues = this.GetEqualizerValues();
        }
        ...
        private void ClearSliders()
        {
            ...
            {
                slider.ValueChanged -= this.slider_ValueChanged;
                this.equalizerGrid.Children.Remove(slider);
            }
            this.sliders.Clear();
        }
        ...
        {
            float[] sliderValues = new float[this.NumberOfBands];
            for (int i = 0; i < this.NumberOfBands; i++)
                sliderValues[i] = (float)this.sliders[i].Value;
            return sliderValues;
        }
